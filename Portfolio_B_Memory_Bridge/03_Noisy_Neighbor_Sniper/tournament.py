...
class SniperAlgorithm(Algorithm):
    """
    Sniper: Identify and throttle only noisy tenants (THE INVENTION).
    
    Uses per-flow rate monitoring to detect statistical outliers
    and applies throttling only to those tenants. Good tenants
